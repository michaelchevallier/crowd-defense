...
namespace CrowdDefense.Entities
{
    ...
    internal static class EnemyBossBehaviors
    {
        // ── Constants ─────────────────────────────────────────────────────────
        ...
        private static System.Collections.IEnumerator FireProjectileRain(Enemy e, int count)
        {
...
#if UNITY_EDITOR
            Debug.Log($"[EnemyBossBehaviors] ai_hub burst — {count} drones spawned");
#endif
        }
        ...
        private static System.Collections.IEnumerator TentacleSlamCoroutine(
...
#if UNITY_EDITOR
            Debug.Log($"[EnemyBossBehaviors] kraken_boss tentacle slam — damage={damage} radius={radius}");
#endif
        }
    }
}
